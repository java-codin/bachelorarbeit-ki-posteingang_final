"""
Zentrale Sammlung von Prompt-Templates für den V4-Prototyp.
Dies trennt LLM-Instruktionen von der Pipeline-Logik und erleichtert gezielte Prompt-Anpassungen.
"""
...
- Erfinde keine Teams.
- Wenn das Anliegen sicherheitskritisch ist und nicht eindeutig fachlich zuordenbar ist, verwende "unknown".
"""
...
- Wenn keine der angegebenen Quellen fuer die Erstellung des Antwortentwurfs zu gebrauchen ist, gib im folgenden Format an:
  Keine spezifischen Quellen zu [Anliegenthema] vorhanden.
- Erfinde keine Informationen.
- Triff keine rechtlich verbindlichen Aussagen.
- Wenn Informationen fehlen, verweise auf manuelle Pruefung.
- Die Antwort ist immer ein Entwurf.
- Nenne am Ende die Quellen, aus denen du die Inhalte des Antwortentwurfs entnommen hast.
