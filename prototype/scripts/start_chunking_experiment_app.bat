...
REM ============================================================
REM Chunking-Experiment Streamlit App
REM ============================================================
...
set "APP_PATH=prototype\apps\chunking_experiment\app.py"
set "APP_PORT=8508"
set "APP_NAME=Chunking-Experiment-App"
...
if not exist "%APP_PATH%" (
    echo [FEHLER] Chunking-Experiment-App nicht gefunden: %APP_PATH%
    pause
    exit /b 1
)
