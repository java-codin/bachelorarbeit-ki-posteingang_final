...
REM ============================================================
REM Haupt-Evaluation Streamlit App
REM ============================================================
...
set "APP_PATH=prototype\apps\evaluation_suite\app.py"
set "APP_PORT=8509"
set "APP_NAME=Haupt-Evaluation-App"
...
if not exist "%APP_PATH%" (
    echo [FEHLER] Haupt-Evaluation-App nicht gefunden: %APP_PATH%
    pause
    exit /b 1
)
